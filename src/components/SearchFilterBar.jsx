        ...
        <div className="md:col-span-2 flex justify-end">
          {hasFilters ? (
            <button
              ...
              className="w-full md:w-auto px-4 py-3 text-xs font-semibold text-[#ff6b6b] hover:bg-[#ff6b6b]/10 rounded-xl transition-colors border border-dashed border-[#ff6b6b]/40 flex items-center justify-center gap-1.5"
            >
